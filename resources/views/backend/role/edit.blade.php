    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('role') }} {{ __('edit') }}
                </h4>
                         ...
                         <div class="col-lg-4">
                             <div class="form-group ">
                                 ...
                                 <input type="text" placeholder="{{ __('enter_name') }}"
                                     class="form-control" name="name" value="{{ old('name',$role->name) }}" >
                                 @error('name')
                             ...
                             <div class="form-group ">
                                 <div class="d-flex justify-content-between">
                                     ...
                                     <input type="checkbox" id="switch4" switch="success" name="status" @if($role->status == App\Enums\Status::ACTIVE) checked=" @endif">
