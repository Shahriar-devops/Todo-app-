    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('user') }} {{ __('create') }}
                </h4>
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="{{ __('enter_designations') }} "
                                        class="form-control" name="designations" value="{{ old('designations') }}" >
                                    @error('designations')
                                        <p class="pt-2 text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text"
                                        class="form-control dateofbirth" name="date_of_birth" readonly value="{{ old('date_of_birth',Date('d/m/Y')) }}" >
                                    @error('date_of_birth')
                                        <p class="pt-2 text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="mr-2"  name="gender"  value="{{ App\Enums\Gender::MALE }}"
                                               @if(old('gender') == App\Enums\Gender::MALE) checked @endif>{{ __('male') }}
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                ...
                                <div class="row profiles">
                                    ...
                                    <div class="col-lg-6">
                                            ...
                                            <div class="cavatar mb-5 user-create cover-avatar text-center">
                                                <div class="thumb">
                                                    <img class="cavatar-img" src="{{ static_asset('backend/images/default/cover-image.jpg') }}" alt="clients">
                                                </div>
                                                <div class="remove-thumb">
                                                    <i class="fa fa-times"></i>
                                                </div>
