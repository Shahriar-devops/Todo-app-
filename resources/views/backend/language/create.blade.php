                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="icon_class" class="form-control" >
                                        ...
                                        @foreach ($flags as $flag)
                                            <option value="{{ $flag->icon_class }}" data-icon="{{ $flag->icon_class }}">{{ $flag->title }}</option>
                                        @endforeach
                                    </select>
                                    @error('icon_class')
                                        <p class="pt-2 text-danger">{{ $message }}</p>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="{{ __('enter_script') }}"
                                        class="form-control" name="script" value="{{ old('script') }}" >
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="{{ __('enter_native') }}"
                                        class="form-control" name="native" value="{{ old('native') }}" >
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="{{ __('enter_regional') }}"
                                        class="form-control" name="regional" value="{{ old('regional') }}" >
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="mr-2"  name="text_direction"  value="ltr"
                                               @if(old('text_direction') == 'ltr') checked @endif>{{ __('ltr') }}
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="mr-2" name="text_direction" value="rtl"  @if(old('text_direction') == 'rtl') checked @endif>{{ __('rtl') }}
                                        </label>
                                    </div>
                                    @error('gender')
                                       <p class="pt-2 text-danger">{{ $message }}</p>
