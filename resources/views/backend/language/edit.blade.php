                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="{{ __('enter_language_name') }}"
                                        class="form-control" name="name" value="{{ old('name',$lang->name) }}" >
                                    @error('name')
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="{{ __('enter_short_code') }}"
                                        class="form-control" name="code" value="{{ old('code',$lang->code) }}" >
                                    @error('code')
                                        <p class="pt-2 text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="{{ __('enter_script') }}"
                                        class="form-control" name="script" value="{{ old('script',@$lang->langConfig->script) }}" >
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="{{ __('enter_native') }}"
                                        class="form-control" name="native" value="{{ old('native',@$lang->langConfig->native) }}" >
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="{{ __('enter_regional') }}"
                                        class="form-control" name="regional" value="{{ old('regional',@$lang->langConfig->regional) }}" >
                                 ...
                                 <div class="form-group margintop35">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="mr-2"  name="text_direction"  value="ltr"
                                               @if(old('text_direction',$lang->text_direction) == 'ltr') checked @endif>{{ __('ltr') }}
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
