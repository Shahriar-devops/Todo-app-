        ...
        <table style="width:100%;height:50px;max-width:650px;margin: auto;background-color: white;box-shadow: 0px 0px 5px rgba(84, 82, 82, 0.1);border-radius: .25rem;">
                <tr>
                    ...
                    overflow: hidden;" colspan="2">
                        ...
                        <p> A request to create your <a href="{{ url('/') }}">{{ $site_name }}</a> account has been made. To complete the registration, click the button below

                        </p>
                        <div style="text-align: center">
                            <a href="{{ route('verify.now',['email'=>$user->email,'verify_token'=>$user->verify_token]) }}" style="background-color: #593bdb;color: white; margin-left:10px;padding: 7px 15px; border: none;text-decoration: none;border-radius: 3px;">Active your account</a>
                        </div>
