                ...
                <tr>
                    ...
                    overflow: hidden;" colspan="2">
                        ...
                        <div style="text-align: center">
                            <a href="{{ url('password/reset/'.$token.'?email='.$email)  }}" style="background-color: #593bdb;color: white; margin-left:10px;padding: 7px 15px; border: none;text-decoration: none;border-radius: 3px;">Reset Password</a>
                        </div>
